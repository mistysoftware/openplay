...
#ifndef __COTATENDPOINT__
#define __COTATENDPOINT__
...
//	------------------------------	Public Types
	...
	class COTATEndpoint : public CEndpoint
	{
	public:
		
		COTATEndpoint(NSpGame *inGame);
...
//		virtual	NMBoolean		Host(NMBoolean inAdvertise);
	...
	//	virtual	const char *GetReliableProtocolName(void) {return kADSPName;}
	//	virtual	const char *GetUnreliableProtocolName(void) {return kDDPName;}
	//	virtual	void		DoPostCreate(PEndpointRef inEndpoint);

	//	OTNameID	mNameID;	
		NMUInt8		mAdvertiseString[256];
	};

#endif // __COTATENDPOINT__