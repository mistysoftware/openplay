 ...
 */
 ...
 //uncomment this to debug this code
// #define DLOPEN_DEBUG 1
 
#if DLOPEN_DEBUG
#define DL_DEBUG_PRINT(format) fprintf(stderr,(format));fflush(stderr)
#define DL_DEBUG_PRINT1(format,arg1) fprintf(stderr,(format),(arg1));\
  fflush(stderr)
#define DL_DEBUG_PRINT2(format,arg1,arg2) fprintf(stderr,(format),\
  (arg1),(arg2));fflush(stderr)
#define DL_DEBUG_PRINT3(format,arg1,arg2,arg3) fprintf(stderr,(format),\
  (arg1),(arg2),(arg3));fflush(stderr)
#else
#define DL_DEBUG_PRINT(format) /**/
#define DL_DEBUG_PRINT1(format,arg1) /**/
#define DL_DEBUG_PRINT2(format,arg1,arg2) /**/
#define DL_DEBUG_PRINT3(format,arg1,arg2,arg3) /**/
#endif
...
int mode)
{
    ...
    char pathbuf[PATH_MAX];
        ...
        DL_DEBUG_PRINT2("libdl: dlopen(%s,0x%x) -> ", path, (unsigned int)mode);
	...
	if(stat(path, &stat_buf) == -1){
	    ...
	    DL_DEBUG_PRINT1("found %s -> ", pathbuf);
	    module_path = pathbuf;
	    dlerror_pointer = NULL;
	}
	else{
...
const char *symbol)
{
    ...
    void *address;
        ...
        DL_DEBUG_PRINT2("libdl: dlsym(%p,%s) -> ", handle, symbol);
...
void * handle)
{
    ...
    void (*fini)(void);
        ...
        DL_DEBUG_PRINT1("libdl: dlclose(%p) -> ", handle);
